...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn tokens(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryTokensRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryTokensResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("hyperlane.warp.v1.Query", "Tokens"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn token(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryTokenResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hyperlane.warp.v1.Query", "Token"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn bridged_supply(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryBridgedSupplyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryBridgedSupplyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hyperlane.warp.v1.Query", "BridgedSupply"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn remote_routers(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryRemoteRoutersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryRemoteRoutersResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hyperlane.warp.v1.Query", "RemoteRouters"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn quote_remote_transfer(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryQuoteRemoteTransferRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryQuoteRemoteTransferResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("hyperlane.warp.v1.Query", "QuoteRemoteTransfer"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod query_server {
    ...
    pub trait Query: Send + Sync + 'static {
        async fn tokens(
            &self,
            request: tonic::Request<super::QueryTokensRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryTokensResponse>,
            tonic::Status,
        >;
        async fn token(
            &self,
            request: tonic::Request<super::QueryTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryTokenResponse>,
            tonic::Status,
        >;
        async fn bridged_supply(
            &self,
            request: tonic::Request<super::QueryBridgedSupplyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryBridgedSupplyResponse>,
            tonic::Status,
        >;
        async fn remote_routers(
            &self,
            request: tonic::Request<super::QueryRemoteRoutersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryRemoteRoutersResponse>,
            tonic::Status,
        >;
        async fn quote_remote_transfer(
            &self,
            request: tonic::Request<super::QueryQuoteRemoteTransferRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryQuoteRemoteTransferResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/hyperlane.warp.v1.Query/Tokens" => {
                    ...
                    struct TokensSvc<T: Query>(pub Arc<T>);
                    impl<T: Query> tonic::server::UnaryService<super::QueryTokensRequest>
                    for TokensSvc<T> {
                        type Response = super::QueryTokensResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Query>::tokens(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/hyperlane.warp.v1.Query/Token" => {
                    #[allow(non_camel_case_types)]
                    struct TokenSvc<T: Query>(pub Arc<T>);
                    impl<T: Query> tonic::server::UnaryService<super::QueryTokenRequest>
                    for TokenSvc<T> {
                        type Response = super::QueryTokenResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::token(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/hyperlane.warp.v1.Query/BridgedSupply" => {
                    #[allow(non_camel_case_types)]
                    struct BridgedSupplySvc<T: Query>(pub Arc<T>);
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryBridgedSupplyRequest>
                    for BridgedSupplySvc<T> {
                        type Response = super::QueryBridgedSupplyResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::bridged_supply(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BridgedSupplySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/hyperlane.warp.v1.Query/RemoteRouters" => {
                    #[allow(non_camel_case_types)]
                    struct RemoteRoutersSvc<T: Query>(pub Arc<T>);
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryRemoteRoutersRequest>
                    for RemoteRoutersSvc<T> {
                        type Response = super::QueryRemoteRoutersResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::remote_routers(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RemoteRoutersSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/hyperlane.warp.v1.Query/QuoteRemoteTransfer" => {
                    #[allow(non_camel_case_types)]
                    struct QuoteRemoteTransferSvc<T: Query>(pub Arc<T>);
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryQuoteRemoteTransferRequest>
                    for QuoteRemoteTransferSvc<T> {
                        type Response = super::QueryQuoteRemoteTransferResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::QueryQuoteRemoteTransferRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::quote_remote_transfer(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = QuoteRemoteTransferSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "hyperlane.warp.v1.Query";
    }
}
/// Generated client implementations.
pub mod msg_client {
