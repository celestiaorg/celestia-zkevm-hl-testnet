...
update-ism:
	@echo "--> Updating ISM"
	@RUST_LOG="ev_prover=info" cargo run -p ev-prover set-token-ism 0x726f757465725f69736d00000000000000000000000000020000000000000003 0x726f757465725f61707000000000000000000000000000010000000000000000
.PHONY: update-ism
